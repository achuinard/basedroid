...
public class BasedroidHttpClient {
    private static final String TAG = "BasedroidHttpClient";
     ...
     * In this case, the server will return something like: {'bool':false}
    ...
    public Boolean userExists(final String username) {
        final String url = "http://www.mywebsite.com/api/json/interaction/checkuser";
        final Map<String, String> requestParams = new HashMap<String, String>();
        requestParams.put("username", username);
        try {
            final JSONObject jo = fetchJsonObject(url, requestParams, RequestType.GET);
            return jo.getBoolean("bool");
